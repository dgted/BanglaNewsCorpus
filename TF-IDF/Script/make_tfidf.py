...
def prepare_tfidf(bow_corpus, dictionary):
...
if __name__ == "__main__":
    ...
    tf_idf_list = prepare_tfidf(bow_corpus, dictionary)

    #print(tf_idf_list[0])

    #minimal_all_list = prepare_bow_list(bow_corpus, dictionary)
    
    with open("test_tfidf.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
        writer.writerows(tf_idf_list)
